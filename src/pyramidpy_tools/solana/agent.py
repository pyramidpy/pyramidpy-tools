...
class SolanaAgentKit:
    ...
    async def launch_pump_fun_token(
        ...
        description: str,
        image_url: str,
        options: PumpfunTokenOptions = None,
    ):
    ...
    async def sell_with_raydium(
        ...
        return RaydiumManager.sell_with_raydium(
    ...
    async def create_gibwork_task(
        ...
        return await GibworkManager.create_gibwork_task(
            self, title, content, requirements, tags, token_mint_address, token_amount
        )
