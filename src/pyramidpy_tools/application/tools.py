...
@tool(name="update_data", description="Update existing data in an application")
def update_data(
    app_id: str,
    doc_id: str,
    data: Dict[str, Any],
...
@tool(name="search_data", description="Search data in an application")
def search_data(
    app_id: str,
...
@tool(name="delete_data", description="Delete data from an application")
def delete_data(
    app_id: str,
